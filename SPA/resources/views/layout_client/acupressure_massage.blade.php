            ...
            <div class="row pt-200">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title mb-60 text-center">
                        ...
                        <h3 class="h3-lg txt-color-01"> {{__('menu.service.service2')}} </h3>
                    </div>
                </div>
            </div>
                                    ...
                                    <li class="pricing-list-txt">
                                        <div class="row">
                                            <div class="col-lg-8 mb-3">
                                                <p class="lbl-pricing txt-color-01"> {!! __('acupressure_massage.service'.$i)!!} </p>
                                                <p class="txt-color-05"> {!! __('acupressure_massage.comment'.$i)!!} </p>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="row text-right">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <p class="lbl-pricing txt-color-01"> {!! __('acupressure_massage.price'.$i)!!} </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
