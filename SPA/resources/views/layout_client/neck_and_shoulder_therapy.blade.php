                                    ...
                                    <li class="pricing-list-txt">
                                        <div class="row">
                                            <div class="col-lg-8 mb-3">
                                                <p class="lbl-pricing txt-color-01"> {!! __('neck_and_shoulder_therapy.service'.$i)!!} </p>
                                                <p class="txt-color-05"> {!! __('neck_and_shoulder_therapy.comment'.$i)!!} </p>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="row text-right">
                                                    ...
                                                    <div class="col-6 text-right">
                                                        <p class="lbl-pricing txt-color-01"> {!! __('neck_and_shoulder_therapy.price'.$i)!!} </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
