...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16911917585"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'AW-16911917585');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-TZCG3QR8');</script>
</head>
<body>
    <div class="container">
        <div class="mx-auto">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TZCG3QR8" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
